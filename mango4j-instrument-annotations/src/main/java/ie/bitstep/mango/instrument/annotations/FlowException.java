 ...
 * parameter without any annotation. This annotation is purely for readability and, if specified, may indicate whether
 * the direct exception or the root cause should be injected.
 */
@Documented
